  ...
  return (
    <section id="projects" className="relative py-28 px-6">
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse 70% 60% at 50% 50%, rgba(0,245,255,0.025) 0%, transparent 65%)' }} />
      ...
      <div ref={ref} className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 20px rgba(0,245,255,0.3), 0 0 40px rgba(255,0,128,0.1)',
                background: '#050816',
              }}
            >
              <img
                src="/avatars_pixelated/new_idea.jpg"
                alt="projects mascot"
                style={{
                  width: '100%',
                  height: '100%',
        ...
        >
          <a href="https://github.com/Nurjol" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#00f5ff] transition-colors duration-200"
            data-hover>
